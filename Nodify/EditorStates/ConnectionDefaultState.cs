...
namespace Nodify
{
    /// <summary>The default state of the <see cref="BaseConnection"/>.</summary>
    public class ConnectionDefaultState : ConnectionState
    {
        ...
        public ConnectionDefaultState(ConnectionContainer container) : base(container)
        {
        }

        /// <inheritdoc />
        public override void ReEnter(ConnectionState from)
        {
